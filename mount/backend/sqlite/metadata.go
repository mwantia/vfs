...
func (sb *SQLiteBackend) ExistsMeta(ctx context.Context, namespace string, key string) (bool, error) {
	sb.mu.RLock()
	defer sb.mu.RUnlock()
	return sb.existsMetaUnsafe(ctx, namespace, key)
}
